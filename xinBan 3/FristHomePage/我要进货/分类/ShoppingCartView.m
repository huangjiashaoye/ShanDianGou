...
//    [self addSubview:_accountBtn];
   ...
   // [_shoppingCartBtn setBackgroundImage:[UIImage imageNamed:@"cart12"] forState:UIControlStateNormal];
    
    _shoppingCartBtn.frame = CGRectMake(self.frame.size.width - 70, - 50, 50,50);
    ...
    if (!_badge) {
        _badge = [[BadgeView alloc] initWithFrame:CGRectMake(_shoppingCartBtn.frame.size.width - 15 -3, 5, 20, 20) withString:nil];
