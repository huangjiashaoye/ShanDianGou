...
- (void)setupMainView
{
    ...
    mainView.backgroundColor = [UIColor colorWithRed:20/255.0 green:113/255.0 blue:237/255.0 alpha:1.0f];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
 ...
 //   cell.imageView.image = self.imagesGroup[itemIndex];
    ...
    [cell.imageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",self.imagesGroup[itemIndex]]]];
    
  //  [cell.imageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@",self.imagesGroup[itemIndex]]]];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.TopMap(indexPath.item % self.imagesGroup.count);
